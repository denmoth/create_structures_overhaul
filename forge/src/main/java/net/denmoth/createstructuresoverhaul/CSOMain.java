...
public class CSOMain {
    ...
    public static void init(RegisterEvent event) {
        event.register(Registries.STRUCTURE_PROCESSOR, new ResourceLocation(MOD_ID, "windmill_bearing"), () -> WINDMILL_BEARING);
        event.register(Registries.STRUCTURE_PROCESSOR, new ResourceLocation(MOD_ID, "ground_marker"), () -> GROUND_MARKER);
        event.register(Registries.STRUCTURE_PROCESSOR, new ResourceLocation(MOD_ID, "solid_ground_marker"), () -> SOLID_GROUND_MARKER);
    }
}

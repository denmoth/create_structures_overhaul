...
public class CSOMain {
    ...
    public static final Supplier<StructureProcessorType<WindmillBearingProcessor>> WINDMILL_BEARING = PROCESSORS.register("windmill_bearing", () -> () -> WindmillBearingProcessor.CODEC);
    public static final Supplier<StructureProcessorType<GroundMarkerProcessor>> GROUND_MARKER = PROCESSORS.register("ground_marker", () -> () -> GroundMarkerProcessor.CODEC);
    public static final Supplier<StructureProcessorType<SolidGroundMarkerProcessor>> SOLID_GROUND_MARKER = PROCESSORS.register("solid_ground_marker", () -> () -> SolidGroundMarkerProcessor.CODEC);

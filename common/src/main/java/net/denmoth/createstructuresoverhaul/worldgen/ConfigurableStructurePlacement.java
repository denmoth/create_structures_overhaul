...
public class ConfigurableStructurePlacement extends RandomSpreadStructurePlacement {
    ...
    public StructurePlacementType<?> type() {
        return ModPlacementTypes.CONFIGURABLE;
    }

    @Override
    public int spacing() {
        return switch (cfgType) {
            case OVERWORLD -> CSOConfig.INSTANCE.overworldSpacing;
            case NETHER -> CSOConfig.INSTANCE.netherSpacing;
        };
    }
    ...
    public int separation() {
        ...
        int separation = switch (cfgType) {
            case OVERWORLD -> CSOConfig.INSTANCE.overworldSeparation;
            case NETHER -> CSOConfig.INSTANCE.netherSeparation;
        };
